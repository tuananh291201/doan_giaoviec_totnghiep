...
import { PRIOTITYSTYELS, TASK_TYPE, STAGE_LABELS } from "../utils/index";
  ...
  const deleteRestoreHandler = async () => {
    ...
    <thead className='border-b border-gray-300 dark:border-gray-600'>
      <tr className='text-black dark:text-white  text-left'>
        ...
        <th className='py-2 line-clamp-1'>Lần sửa đổi cuối</th>
      </tr>
    </thead>
  );
const TableRow = ({ item }) => (
      ...
      <div className='w-full md:px-1 px-0 mb-6'>
        ...
        {data?.tasks?.length > 0 ? (
          ...
          <div className='w-full flex justify-center py-10'>
            <p className='text-lg text-gray-500'>Không có công việc trong thùng rác</p>
          </div>
        )}
      </div>
